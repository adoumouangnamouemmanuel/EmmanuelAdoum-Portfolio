...
export default function BlogPage() {
  ...
  const t = isFr
    ? {
        ...
        titleAccent: "Blog.",
        subtitle:
          "Analyses techniques, patterns d'architecture et retours d'expérience au cœur de l'ingénierie web.",
        ...
        min: "MIN",
        explore: "Explorer",
        noPostsTitle: "Aucun article trouvé.",
        noPostsBody:
        ...
        next: "Suivant",
        tags: "Tags",
        allOperations: "Toutes les catégories",
        closureLead: "Accéder à",
        closureAccent: "l'archive.",
        closureBtn: "Voir les projets",
      }
    : {
        ...
        noPostsBody: "No blog posts match your search or filter parameters.",
        resetFilters: "Reset Filters",
        previous: "Previous",
        next: "Next Page",
        tags: "Tags",
        allOperations: "All Operations",
        closureLead: "Access the",
        closureAccent: "Archive.",
        closureBtn: "View Project History",
      };
  ...
  const featuredPost = blogPostsData.slice().sort((a, b) => {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 selection:bg-blue-200 dark:selection:bg-blue-900/50">
      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
          ...
          >
            ...
            {session && (
              <Link
                href={`${basePath}/blog/create`}
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-blue-600 hover:bg-blue-700 text-white text-[10px] sm:text-xs font-bold tracking-widest uppercase transition-all duration-300 shadow-md"
              >
          ...
          <div className="max-w-4xl">
            ...
            >
              {t.titleLead}{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 pb-2">
                {t.titleAccent}
              </span>
            </motion.h1>
            <motion.p
                      ...
                      <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex flex-col gap-1 shadow-sm">
                        <button
                          ...
                          className={`w-full text-left px-5 py-4 rounded-xl text-sm font-medium transition-all duration-300 ${
                            selectedCategories.length === 0
                              ? "bg-slate-900 dark:bg-white text-white dark:text-slate-900 shadow-sm translate-x-1"
                ...
                featuredPost && (
                  ...
                  >
                    ...
                    <div className="group relative rounded-3xl overflow-hidden bg-slate-100 dark:bg-slate-900 aspect-[4/3] sm:aspect-video mb-8 transition-transform hover:-translate-y-2 hover:shadow-2xl duration-700">
                      ...
                      <Image
                        src={
                          featuredPost.coverImage || "/images/posts/blog.avif"
                        }
                      ...
                      <div className="absolute inset-0 z-10 p-8 sm:p-12 flex flex-col justify-end pointer-events-none">
                        ...
                        <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-[10px] sm:text-xs font-bold tracking-widest uppercase text-slate-300">
                          ...
                          <span className="hidden sm:flex items-center gap-2 relative z-20">
                  ...
                  >
                    <div className="inline-flex items-center p-1 rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
                      ...
                      <span className="px-6 py-3 text-[10px] sm:text-xs font-bold tracking-widest text-slate-400 border-l border-r border-slate-200 dark:border-slate-800/60">
                        {currentPage} <span className="opacity-50 mx-1">/</span>{" "}
                        {totalPages}
                      </span>
                  ...
                  <div className="flex flex-col gap-1">
                    <button
                      ...
                      className={`w-full text-left px-5 py-4 rounded-2xl text-sm sm:text-base font-medium transition-all duration-300 ${
                        selectedCategories.length === 0
                          ? "bg-slate-900 dark:bg-white text-white dark:text-slate-900 shadow-md translate-x-2"
                          : "text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900/50 hover:pl-6"
                      }`}
                    >
                      {t.allOperations}
                    </button>
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-[10px] sm:text-xs font-bold tracking-widest uppercase transition-colors duration-300 ${
                          selectedCategories.includes(tag)
                            ...
                            : "border border-slate-200 dark:border-slate-800 text-slate-500 hover:border-slate-400 dark:hover:border-slate-600"
                        }`}
                      >
                        {tag}
                      </button>
      ...
      <section className="py-24 sm:py-32 bg-slate-900 dark:bg-slate-950 border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-6 sm:px-12 text-center">
          <h2 className="text-4xl sm:text-6xl font-bold tracking-tighter text-white mb-10">
            {t.closureLead}{" "}
